...
data = [{"id":1,"name":"Akshay","sname":"Waghmare","email":"name"+"sname"+"@gmail.com","phone":1111, "Tal":"Akluj","state":"Maha","course":["python","html","css"],"pincode":11},                                                    
    {"id":2,"name":"Suraj","sname":"Jagtap","email":"name"+"sname"+"@gmail.com","phone":2222, "Tal":"Shreerampur","state":"Maha","course":["python","hadoop","javascript"],"pincode":22},                                                    
    {"id":3,"name":"Shubham","sname":"Madavi","email":"name"+"sname"+"@gmail.com","phone":3333, "Tal":"Akluj","state":"Maha","course":["python","mongoDB","js"],"pincode":33},                                                    
